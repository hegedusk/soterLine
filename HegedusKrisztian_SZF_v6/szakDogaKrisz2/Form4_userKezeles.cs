...
// groupbox2 a groupbox1-en "fekszik", ha lehúzom róla, akkor látszik majd :)
// + a label combobox lett, + lett 1 gomb (törlés)

namespace szakDogaKrisz2
{
    public partial class Form4_userKezeles : Form
    {
        ...
        public Form4_userKezeles(string felhNev)
        {
            InitializeComponent();
